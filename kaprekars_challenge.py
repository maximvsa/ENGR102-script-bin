...
# Name:         Maximus Amick
# Section:      513
# Assignment:   7.21 LAB: Kaprekar's constant challenge (bonus)
# Date:         2 October 2025
...
def main(n):
    ...
    # Handle special cases where input is already 6174 or already 0000
    if number == 6174:
        return 0
    if number == 0:
        return 0
    ...
    while number != 6174:
        ...
        # If we get 0, all digits were the same - reached 0000 in this iteration
        if number == 0:
            return iterations + 1
...
if __name__ == "__main__":
    print(f"Kaprekar's routine takes {repeater()} total iterations for all four-digit numbers")