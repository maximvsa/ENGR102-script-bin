test_cases = open('C:/Users/maxim/engr_102/tyr_test_cases.py', 'w')

# example test case line:
#
# sex:F age:40 cho:105 smo:N hdl:60 sbp:100 med:N out:<1

possible_sex_values = ['M', 'F']
possible_age_values = [20, 45, 60]
possible_cho_values = [150, 300]
possible_smo_values = ['Y', 'N']
possible_hdl_values = [35, 65]
possible_sbp_values = [110, 130, 150]
possible_med_values = ['Y', 'N']
...
# Female calculations
                                ...
                                # Ignore this test case if any error occurs
                                pass
